...
function sendDataPeriodically() {
    setInterval(() => {
        ...
        const iotData = {
            iotDeviceId: "Rajagiriya Junction",
            gpsLatitude: 6.9147, // Static example data (Kadawathe location)
            gpsLongitude: 79.8996, // Static example data (Kadawathe location)
            co2Level: Math.random() * 200 + 400, // Random CO2 level between 400 and 500
            ch4Level: Math.random() * 10, // Random CO level between 0 and 5
