...
function sendDataPeriodically() {
    setInterval(() => {
        ...
        const iotData = {
            iotDeviceId: "Koswatta Junction",
            gpsLatitude: 6.9091, // Static example data (Kadawathe location)
            gpsLongitude: 79.9392, // Static example data (Kadawathe location)
            co2Level: Math.random() * 100 + 400, // Random CO2 level between 400 and 500
            ch4Level: 0.0115, // Random CO level between 0 and 5
            no2Level: 0.0001,
