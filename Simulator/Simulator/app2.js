...
function sendDataPeriodically() {
    setInterval(() => {
        ...
        const iotData = {
            iotDeviceId: "Diyatha Uyana",
            gpsLatitude: 6.9098, // Static example data (Kadawathe location)
            gpsLongitude: 79.9172, // Static example data (Kadawathe location)
            co2Level: 0.0012, // Random CO2 level between 400 and 500
            ch4Level: 0.0002, // Random CO level between 0 and 5
            no2Level: 0.0001,
